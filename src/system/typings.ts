...
export const TRANSITION_DURATION: Readonly<
  Record<TransitionDurationType, number>
> = {
  shortest: 150,
  shorter: 200,
  short: 250,
...
export const TRANSITION_EASING: Readonly<
  Record<TransitionEasingType, string>
> = {
